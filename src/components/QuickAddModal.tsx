      ...
      {isOpen && (
        <>
          ...
          >
            ...
            {/* Error Toast / Alert */}
            {errorMessage && (
              <div className="mt-4 p-3 bg-red-900/40 border border-red-500/50 text-red-200 text-xs font-mono rounded flex items-center justify-between">
              ...
              <div className="grid grid-cols-5 gap-2">
                {product.sizes.map((size) => (
                  <button
                    ...
                    className={`py-2.5 text-xs font-bold font-mono rounded-sm transition-all border ${
                      selectedSize === size
            ...
            <button
              ...
              className="w-full py-4 bg-[#C8FF00] text-[#080808] font-bold font-mono text-sm tracking-widest uppercase rounded-sm hover:bg-[#d4ff33] transition-all flex items-center justify-center space-x-2"
            >
